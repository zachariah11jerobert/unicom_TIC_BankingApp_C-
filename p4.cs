namespace BankApp
{
    ...
    class Bank
    {
        ...
        public void printAsTableAccounts()
        {
            string tblStr = "AccountNumber |\tAccountHolderName |\t Balance \n";
            tblStr = tblStr + "-----------------------------------------------\n";
            for (int i = 0; i < accountIndex; i = i + 1)
            {
                tblStr = tblStr + accounts[i].accountNumber + " |\t" + accounts[i].accountHolderName + " |\t" + accounts[i].balance + "\n";
            }

            Console.WriteLine(tblStr);
        }
    }
